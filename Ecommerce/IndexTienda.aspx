<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IndexTienda.aspx.cs" Inherits="Ecommerce.WebForm2" %>
		...
		<div class="container">
			...
			<div class="agile-login">
				<ul>
					...
					<li><a href="indexAdmin.aspx">Login</a></li>
			...
			<div class="product_list_header">  
					<form action="#" method="post" class="last"> 
						...
						<button class="w3view-cart" type="submit" name="submit" value=""><i class="fa fa-cart-arrow-down" aria-hidden="true">
                            <img alt="" src="images/carro.png"  style="width:45px; height:45px;"/></i></button>
					</form>  
			</div>
		...
		<div class="w3l_search">
			<form action="#" method="post">
				...
				<button type="submit" class="btn btn-default search" aria-label="Left Align">
					<img alt="" src="images/buscar.png" style="width:25px; height:25px;" /><i class="fa fa-search" aria-hidden="true"> </i>
				</button>
				<div class="clearfix"></div>
			</form>
		</div>
